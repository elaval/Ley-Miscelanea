      ...
      <div>
        ...
        <p className="text-sm text-slate-500 max-w-xs">
          <span className="hidden md:inline">
            Usa el panel izquierdo para navegar entre los 33 artículos permanentes y 17 transitorios.
          </span>
          <span className="md:hidden">
            Toca el botón <span className="font-semibold">☰</span> (arriba a la izquierda) para navegar entre los 33 artículos permanentes y 17 transitorios.
          </span>
        </p>
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-left">
